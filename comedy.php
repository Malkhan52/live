    ...
    _________________________________________________________ -->
		 ...
		 <div id="heading-breadcrumbs" style="background-image:url(asset/images/background.jpg) !important;margin-bottom:0px;margin-top:4em;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="font-family: patua;">BHUBANESWAR KOMEDIANS</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li style="font-family: patua;">COMEDY</li>
            ...
            <div class="container">
                ...
                <div class="row portfolio-project">
					...
					<div class="col-sm-4">                           
						<img src="asset/images/events/comedy.jpg" alt="" class="img-responsive">
					...
					<div class="col-sm-8">
                        <div class="col-sm-12" >                            
							<div class="project-more" >
                                ...
                                <p style="color:black;font-family: proxima;font-size:1em;">6:00PM</p>
                                
                                </div>
								 
                            </div>
							
							<div class="col-sm-4" id="share-buttons">
								<h5 style="font-family: haymaker;">You can share it on </h5>
							</div>
							<div class="col-sm-6" id="share-buttons">
								
								<!-- Facebook -->
								<a href="https://www.facebook.com/sharer/sharer.php?u=http://nitrutsav.nitrkl.ac.in/comedy.php" target="_blank">
									<img src="facebook.png" alt="Facebook" />
								</a>
								
								<a class="hidden-lg" href="whatsapp://send?text=Hey! Come be a part of our comedy night in NITRUTSAV 2018. http://nitrutsav.nitrkl.ac.in/comedy.php" data-action="share/whatsapp/share">
						...
						<div class="col-sm-12">
							<div class="tabs" >
								<ul class="nav nav-tabs ">
									<li class="active"><a style="font-family: haymaker;background-color:transparent;" href="#tab2-1" data-toggle="tab">Description</a>
                                    </li>
                                    
								</ul>
								<div class="tab-content tab-content-inverse">
									<div class="tab-pane active" style="font-family: proxima;font-size:1.2em;" id="tab2-1">
										"The duty of comedy is to correct men by amusing them."<br/>

										<br/>Adhering to this very famous quote by Moliere, NITRutsav 2018 brings to you an evening filled with fun and frolic and uncontrollable fits of laughter, 
										as Bhubaneswar Komedians make their way to NIT Rourkela to deliver comic relief, fresh and authentic!</br>

										<br/>Catch them live and in action from 6 PM onwards on the 3rd of Feb.<br/>
									</div>
